...
exports.generateTokenPromise = generateTokenPromise;
...
function get_xoauth2_token(xoauth2gen) {
    return __awaiter(this, void 0, void 0, function* () {
        let token = '';
        token = yield xoauth2gen.getToken(function (err, token) {
...
function generateTokenPromise(xoauth2gen) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise(resolve => {
            resolve(xoauth2gen.getToken((err, token) => {
                if (err) {
                    console.log(err);
                }
                return token;
