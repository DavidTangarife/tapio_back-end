...
const opportunity_model_1 = __importDefault(require("./opportunity.model"));
...
projectSchema.pre("deleteOne", { document: true, query: false }, function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield status_model_1.default.deleteMany({ projectId });
        yield opportunity_model_1.default.deleteMany({ projectId });
        next();
    });
});
